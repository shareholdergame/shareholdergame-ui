...
{#if turn !== undefined && turn.steps !== undefined}
    {#if turn.round === 0}
        <div class="col-md-3 color-turn-{turn.turn} bgcolor-turn-{turn.turn}">
            <BuySellStepItem step="{turn.steps[StepType.ZERO_STEP]}"/>
        </div>
        <div class="col-md-4 color-turn-{turn.turn} bgcolor-turn-{turn.turn}">
    ...
    {:else}
        ...
        <div class="col-md-1 color-turn-{turn.turn} bgcolor-turn-{turn.turn}">
        </div>
    {/if}
{/if}
